...
//          {/* <div className="max-w-5xl px-4 py-4 mx-auto sm:py-12 sm:px-12"> */}
...
//                                  {/* <CarouselItem key={id} className="basis-[80%] sm:basis-[40%] md:basis-[30%] lg:basis-[25%] xl:basis-[20%] group"> */}
//                                       <div className="p-1">
